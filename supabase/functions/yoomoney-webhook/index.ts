...
//
// Деплой (важно --no-verify-jwt, иначе ЮMoney не сможет вызвать без токена):
//   supabase functions deploy yoomoney-webhook --no-verify-jwt
//   supabase secrets set YOOMONEY_NOTIFICATION_SECRET=ВАШ_СЕКРЕТ
//
// URL для поля "Куда отправлять" в настройках ЮMoney:
//   https://<project-ref>.functions.supabase.co/yoomoney-webhook
//
