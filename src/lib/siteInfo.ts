 ...
 *
 * ⚠️ ПЕРЕД ПОДАЧЕЙ САЙТА НА МОДЕРАЦИЮ AnyPay заполните реальными данными:
 *  - operatorName: полное ФИО (вы указали статус «физлицо без статуса»);
 *  - email / telegram: действующие каналы связи.
 * Всё в одном месте, чтобы не искать по страницам.
 */
export const SITE = {
  name: 'APSNY-TRANSFER',
