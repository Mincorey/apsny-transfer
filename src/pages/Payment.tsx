...
const STEPS = [
  ...
  {
    n: '3',
    t: 'Оплата публикации — 100 ₽',
    d: 'Перед размещением объявления вносится фиксированная плата 100 ₽ через платёжную систему AnyPay. Оплата производится онлайн банковской картой.',
  },
  {
    n: '4',
    t: 'Публикация и аукцион',
    d: 'После успешной оплаты поездка публикуется в общей ленте и становится доступной для ставок других участников.',
  },
];
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-on-surface-variant">
              Описание платной услуги сервиса APSNY-TRANSFER и порядок оплаты
            </p>
          </div>
          ...
          <div className="glass-panel rounded-2xl p-6 space-y-3">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              APSNY-TRANSFER — это онлайн-площадка для организации совместных поездок по
              маршрутам Сочи ↔ Абхазия. Сервис сводит между собой водителей и пассажиров:
          ...
          <div className="glass-panel rounded-2xl p-6 space-y-4">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                'Услуга доступна как водителям (объявления «Я ЕДУ»), так и пассажирам (объявления «Я ВЕЗУ»).',
                'Воспользоваться услугой могут только зарегистрированные и авторизованные пользователи.',
                'Стоимость фиксированная — 100 ₽ за одно объявление, независимо от маршрута и даты.',
              ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <InfoCard icon={<Receipt size={20} />} title="Способ оплаты">
              Оплата производится онлайн банковской картой через защищённую платёжную
              систему AnyPay. Данные карты вводятся на стороне платёжной системы и сервису
              не передаются.
            </InfoCard>
            <InfoCard icon={<ShieldCheck size={20} />} title="Безопасность">
              Все платежи проходят по защищённому соединению. APSNY-TRANSFER не хранит
              реквизиты банковских карт пользователей.
            </InfoCard>
            <InfoCard icon={<CheckCircle2 size={20} />} title="Что вы получаете">
              После оплаты ваше объявление о поездке публикуется в ленте сервиса и
              становится доступным для участия в аукционе другим пользователям.
            </InfoCard>
          ...
          <div className="glass-panel rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a
              href="mailto:support@apsny.transfer"
