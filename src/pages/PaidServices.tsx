...
const STEPS = [
  ...
  },
  {
    ...
    d: 'За размещение объявления предусмотрена фиксированная плата 100 ₽. Оплата производится онлайн банковской картой или через СБП с помощью платёжной системы ЮMoney. На время подключения ЮMoney публикация временно бесплатна: плата не взимается, платёжные данные не запрашиваются.',
  },
  {
    n: '4',
