...
const STEPS = [
  ...
  {
    n: '3',
    t: 'Публикация — 100 ₽ (сейчас бесплатно)',
    d: 'За размещение объявления предусмотрена фиксированная плата 100 ₽. Оплата производится онлайн банковской картой или через СБП с помощью платёжной системы Platega. На время подключения Platega публикация временно бесплатна.',
  },
  {
    n: '4',
        ...
        >
          ...
          <div className="glass-panel rounded-2xl p-6 space-y-4">
            ...
            <div className="flex items-start gap-2.5 rounded-xl bg-[#00e290]/10 border border-[#00e290]/30 px-4 py-3 text-sm text-[#00e290]">
              ...
              <span>
                ...
                подключения платёжной системы Platega. Плата 100&nbsp;₽ будет взиматься позже.
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <InfoCard icon={<Receipt size={20} />} title="Способ оплаты">
              ...
              платёжной системы Platega. Реквизиты вводятся на стороне платёжной
