...
const STEPS = [
  ...
  },
  {
    ...
    d: 'Перед размещением объявления вносится фиксированная плата 100 ₽. Оплата производится онлайн банковской картой через защищённую платёжную систему.',
  },
  {
    n: '4',
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <InfoCard icon={<Receipt size={20} />} title="Способ оплаты">
              ...
              систему. Данные карты вводятся на стороне платёжной системы и сервису
              не передаются.
            </InfoCard>
