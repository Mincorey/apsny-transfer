...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Контакты скрыты до конца аукциона. Как только определён победитель, второй стороне сделки открывается Telegram — дальше вы списываетесь и договариваетесь сами.',
  },
  {
