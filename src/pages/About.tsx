...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Есть два сценария. «Я ВЕЗУ» — водитель публикует предложение, пассажиры торгуются на повышение. «Я ЕДУ» — пассажир публикует запрос, водители торгуются на понижение цены. Победитель один, и он забирает поездку целиком: число мест — это вместимость машины, вы можете ехать один или взять с собой попутчиков. Победитель определяется по таймеру или при досрочном закрытии создателем.',
  },
  {
    q: 'Когда открываются контакты?',
    a: 'Контакты скрыты до конца аукциона. Как только определён победитель, стороны сделки видят контакты друг друга — телефон, Telegram, WhatsApp и MAX, если они указаны в профиле. Дальше вы связываетесь и договариваетесь напрямую.',
  },
  {
    ...
    <InfoLayout title="О проекте" subtitle={SITE.tagline}>
      ...
      <Section title="Как это работает">
        ...
        <Step
          ...
          text="Вторая сторона делает ставки: водители — на понижение цены, пассажиры — на повышение. Список ставок обновляется автоматически, пока идёт торг."
        />
        <Step
          icon={<Trophy size={18} />}
